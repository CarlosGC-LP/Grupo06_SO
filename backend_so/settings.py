"""
Django settings for backend_so project.
...
SECRET_KEY = 'django-insecure-tgrnmfaa%!za!4%pgdwbf=*0)!2t(ep2s6pgbm21739td0jur2'
...
WSGI_APPLICATION = 'backend_so.wsgi.application'
